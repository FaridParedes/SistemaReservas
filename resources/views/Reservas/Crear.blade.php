    ...
    <div class="container">
        ...
        <div class="w-100">
            <ul class="nav nav-underline">
                @if ($id != 0)
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/reservas/crear/{{$id}}">Reservar por rango de fechas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-success" href="/reservas/crear/dia/{{$id}}">Reservar por un día</a>
                    </li>
                @else
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/reservas/crear">Reservar por rango de fechas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-success" href="/reservas/crear/dia">Reservar por un día</a>
                    </li>
                @endif
              </ul>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="w-100">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="/reservas/store">
                            @csrf         
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="fechaInicio" type="date" class="form-control" value="{{ old('fechaInicio')}}" required>
                                @error('fechaInicio')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="fechaFinal" type="date" class="form-control" value="{{ old('fechaFinal')}}" required>
                                @error('fechaFinal')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
                            ...
                            <div class="col-md-12">
                                <label  class="form-label">Días a reservar, seleccione uno o más</label>
                                <div name="dia" class="row g-1">
                                    @foreach ($dias as $dia)
                                    <div class="form-check col-md-1">
                                        <input class="form-check-input" type="checkbox" value="{{$dia->idDias}}" name="dia[]"
                                        {{ in_array($dia->idDias, (array) old('dia', [])) ? 'checked' : '' }}
                                        >
